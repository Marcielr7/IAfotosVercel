...
const options = {
  ...
  onValidate: async (file: File): Promise<undefined | string> => {
    ...
    return isSafe
      ? undefined
      : "Detectou algo anormal?, mande um email para www.marciel@hotmail.com"//"Detected a NSFW image which is not allowed. If this was a mistake, please contact me at hassan@hey.com";
  },
};
...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-4 sm:mb-0 mb-8">
        <a
          href="linkedin.com/in/marcielrr7"
          target="_blank"
          rel="noreferrer"
  ...
  photos generated and counting. */}
          <AdSenseBanner adClient="ca-pub-3896969974372537" adSlot="9721369009" />
